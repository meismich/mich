...
for i in `cat bar.usr`; do
	...
	/home/mspence/src/bulkassetreps/mar.sh $j $k $d
done

/home/mspence/src/bulkassetreps/mas.sh mspence@apeagers.com.au $d
/home/mspence/src/bulkassetreps/mas.sh spearce@apeagers.com.au $d
